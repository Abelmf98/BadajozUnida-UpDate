...
class modelo
{
    private $conexion;
    public $_respuestas;
    public $_idUbicacion; //nueva variable
    ...
    //metodo metodo
    public function set_idUbicacion($ubicacion)
    {
      $this->_idUbicacion = $ubicacion;
    }
  ...
  /**
   * Realiza la consulta y devuelve las filas afectadas
   * Se usará para insertar, y en caso de ser una ubicación, devolver el ultimoId
   * @param $query, $ubicacion
   * @return int
   */
    public function nonQueryId($query, $ubicacion=false){
        $resultado = $this->conexion->consulta($query, $ubicacion);
