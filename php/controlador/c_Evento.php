...

{
...

  {
    ...
    if (
      !isset($datos['titulo']) || !isset($datos['descripcion']) || !isset($datos['fechaHora']) ||
...

  {
    ...
    $query = "SELECT e.idEvento, e.titulo, e.imagen, e.descripcion, e.fechaHora ,
              ...
              u.nombre as 'nombreUbicacion', u.latitud as 'latitud', u.longitud as 'longitud', s.nombre as 'nombreSubcateogria', concat(u2.nombre,' ', u2.apellidos) as 'nombreCreador',
...

  {
    ...
    $query = "select e.idEvento, e.titulo, e.imagen, e.descripcion, e.fechaHora ,
              ...
              u.nombre as 'nombreUbicacion', u.latitud as 'latitud', u.longitud as 'longitud', s.nombre as 'nombreSubcategoria', concat(u2.nombre,' ', u2.apellidos) as 'nombreCreador',
  ...
  function realizarRegistroEvento($datos)
  {
    $query = "INSERT INTO Evento (titulo, imagen, descripcion, fechaHora, idUbicacion,idUsuario, idSubcategoria)
                ...
                , " . $datos['idUbicacion'] . ", " . $datos['idUsuario'] . ", '" . (int)$datos['idSubcategoria'] . "');";
